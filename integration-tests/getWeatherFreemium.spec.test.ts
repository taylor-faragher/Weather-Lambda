    ...
    it('GET with no params returns weather for default city, Washington DC', done => {
        request(baseUrl)
            ...
            .end((err, res) => {
                ...
                expect(res.body.current).not.toHaveProperty('minTemperature');
                expect(res.body.current).not.toHaveProperty('maxTemperature');
                ...
                expect(res.body.current).not.toHaveProperty('windSpeed');
